...
public class MemberDto {
    ...
    public MemberDto(String memberImage, String imagePath) {
    ...
    public static MemberDto toMemberDto(MemberEntity memberEntity) {
        ...
        memberDto.setMemberImage(memberEntity.getMemberImage());
        memberDto.setImagePath(memberEntity.getImagePath());
        return memberDto;
    }
